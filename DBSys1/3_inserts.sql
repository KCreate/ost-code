...
INSERT INTO person (name, surname, address)
VALUES
...
INSERT INTO delivery_driver (person_id, salary, employment_date)
VALUES
        (1, 5200.00, '2005-06-12'),
        (2, 5600.50, '2008-03-05'),
        (5, 4200.50, '2015-04-02');

INSERT INTO "order" (delivery_driver, customer, date, delivery_address, payment_outstanding)
VALUES
...
INSERT INTO order_item ("order", pizza_type, amount)
VALUES
        (1, 1, 2),
        (1, 2, 2),
        (2, 3, 3),
...
INSERT INTO ingredient (pizza_type, topping, extra)
VALUES
        (1, 1, false),
        (1, 2, false),
        (1, 4, false),
